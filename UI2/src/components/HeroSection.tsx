      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-primary text-primary-foreground rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all inline-block"
          >
            Start Analysis
          </motion.a>
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-card text-card-foreground border-2 border-primary rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all inline-block"
          >
            Explore the Bridge
          </motion.a>
        </motion.div>
